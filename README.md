...
## 🔑 Seed Credentials
The system comes with pre-seeded accounts for testing. All accounts use the same password.

**Password:** `Admin@1234`

*   **Admin:** `admin@pawlink.com`
*   **Public User:** `user@pawlink.com`
*   **Shelter Org:** `shelter@pawlink.com`
